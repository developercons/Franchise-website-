...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.blogs.update', $dataTypeContent->id) }}@else{{ route('voyager.blogs.store') }}@endif" method="POST" enctype="multipart/form-data">
