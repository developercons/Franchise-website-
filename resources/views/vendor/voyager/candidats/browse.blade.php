                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'checkbox')
                                                    @if($options && property_exists($options, 'on') && property_exists($options, 'off'))
                                                        ...
                                                        @else
                                                        <span class="label label-primary" style="background: red;">{{ $options->off }}</span>
                                                        <a href="{{route('voyager.updateCandidat', ['id' => $data->id])}}" 
                                                           class="btn btn-primary btn-update" 
                                                            style="font-size: 12px;background: #f4a62a;padding: 5px;">
                                                           Valider
                                                        </a>                                                    
                                                        @endif
